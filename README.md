...
El motor es **GPL v2**: los sidecars (crypto, red, blockchain) viven fuera del binario y
se comunican por ficheros spool/RPC (aislamiento de licencia y de latencia).
...
```
  BUILD_SERVER            - build the 'q4ded' server binary
